...
public: //se ocupaba hacer un public aqui porque como el iterador es publico su prototipo tambien
	...
	public:
		...
		void insertar(int dato){
			Nodo* hoja = new Nodo(dato); /** crea en el heap un nodo hoja con los parámetros recibidos y guarda su referencia */
...
// el método insertar de árbol más adelante recibirá key y dato como parámetros
// cuando se utilice el método insertar en el árbol rojinegro, lo que se comparan son las llaves no los datos, aplicar este cambio
...
//linea 429 le agregue un setPila a iterador de albol
